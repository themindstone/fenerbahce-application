...
const dummyDatas: UtilityCardProps[] = Array(15)
	.fill(dummyData)
	.map(i => {
		i.id = Math.random();
		return i;
	...
	return (
		<Flex
			...
			<Flex pos="absolute" gap="5px" top="240px" direction="column" p="20px">
				<Text fontWeight="bold" color="var(--golden-fizz)">
...
export const Utility = (): ReactElement => {
	return (
		<Flex direction="column" gap="50px" alignItems="center" className="utility-container">
