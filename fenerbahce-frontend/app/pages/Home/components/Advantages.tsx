...
export const Advantages = (): ReactElement => {
	return (
		<Flex direction="column" maxW="1200px" m="100px auto" gap="30px" alignItems="center" textAlign="center">
			<Heading maxW="30ch">Fenerbahce Token taraftarlara hangi avantajlari saglayacak?</Heading>
			<Carousel options={options}>
				{homeutility.map((item, index) => {
					return <AdvantageCard key={index} avatarUrl={item.avatarUrl} title={item.title} text={item.text} />;
				})}
			</Carousel>
		</Flex>
	);
