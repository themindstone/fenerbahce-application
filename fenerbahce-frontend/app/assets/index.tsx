...
export const UserIcon = (props: SVGProps<SVGSVGElement>): ReactElement => (
	<svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
		<g clipPath="url(#clip0_30_260)">
			<path
				d="M13.4286 5.06394C13.4286 6.47802 12.8689 7.75694 11.9664 8.6753C11.084 9.57376 9.87378 10.1279 8.5386 10.1279C7.19397 10.1279 5.97605 9.56587 5.09205 8.65609C4.20052 7.73892 3.64862 6.46824 3.64862 5.06394C3.64862 2.26717 5.83791 0 8.5386 0C11.2393 0 13.4286 2.26752 13.4286 5.06394Z"
				fill={props.fill || "#1B2F6E"}
			/>
			<path
				d="M17 15.1867C14.6171 16.9573 11.6953 17.9997 8.53857 17.9997C5.3476 17.9997 2.39697 16.9344 6.10352e-05 15.1288C0.130913 11.904 1.9886 9.78849 4.655 8.80469C4.69851 8.85323 4.74287 8.90089 4.78809 8.94766C5.27163 9.4487 5.84406 9.84833 6.47393 10.1246C7.2868 10.4809 8.17275 10.6211 9.05128 10.5327C9.92981 10.4442 10.7731 10.1298 11.5044 9.61808C11.786 9.421 12.0488 9.19651 12.2891 8.94766C12.3274 8.90803 12.3651 8.86775 12.4021 8.82681C15.0526 9.82605 16.8899 11.9531 17 15.1867Z"
				fill={props.fill || "#1B2F6E"}
			/>
		</g>
		<defs>
...
export const ArrowForwardIcon = (props: SVGProps<SVGSVGElement>): ReactElement => (
...
export const MinusIcon = (props: SVGProps<SVGSVGElement>): ReactElement => (
	<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#fff" {...props}>
		<path d="M0 0h24v24H0z" fill="none" />
