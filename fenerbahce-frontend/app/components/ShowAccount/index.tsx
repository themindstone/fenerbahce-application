...
export const ShowAccount = (): ReactElement => {
    ...
    return (<Flex direction="column" bg="#f5f5f5" gap="15px" borderRadius="10px" ref={ref} p="20px" color="var(--biscay)" pos="relative">
        ...
        <Flex justifyContent="space-between" cursor="pointer" maxW="calc(100% - 30px)" gap="10px" onClick={copy}>
            <Flex maxW="100%">
                <Text whiteSpace="nowrap" overflow="hidden" textOverflow="ellipsis">{connectWallet.address}</Text>
        ...
        <Link href="#">
            <Flex gap="10px" alignItems="center" justifyContent="center">
                ...
                <Text textAlign="center">View on Avascan</Text>
            </Flex>
        </Link>
    </Flex>);
};